...
<?php hbmon_seo_head('Log Monitor'); ?>
  ...
  <div class="hbmon-page">
    ...
    <main class="hbmon-shell">
      ...
      <fieldset class="hbmon-panel" style="font-size:14px; border-radius: 10px;">
        ...
        <pre id="log" role="log" aria-live="polite" aria-relevant="additions" aria-label="Live call log" style="height: 40em; text-align: left; overflow-y: auto; font-size:12px; background-color: #000000; color:#729fcf;"></pre>
      </fieldset>
    </main>
    <!--footer-->
